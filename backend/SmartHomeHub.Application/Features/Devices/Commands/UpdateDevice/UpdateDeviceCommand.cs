...
public record UpdateDeviceCommand(
    ...
    DeviceType Type, 
    Guid? RoomId, 
    string FirebaseUid) : ICommand<Result>;
...
public class UpdateDeviceCommandHandler(IAppDbContext dbContext) : ICommandHandler<UpdateDeviceCommand, Result>
{
    public async ValueTask<Result> Handle(UpdateDeviceCommand request, CancellationToken cancellationToken)
    {
