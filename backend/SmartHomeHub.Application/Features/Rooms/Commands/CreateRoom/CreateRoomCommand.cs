...
public record CreateRoomCommand(string Name, string Icon, string FirebaseUid) : ICommand<Result<Guid>>;
...
public class CreateRoomCommandHandler(IAppDbContext dbContext) : ICommandHandler<CreateRoomCommand, Result<Guid>>
{
