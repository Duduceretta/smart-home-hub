...
public class DeleteRoomCommandHandler(IAppDbContext dbContext) : ICommandHandler<DeleteRoomCommand, Result>
{
    public async ValueTask<Result> Handle(DeleteRoomCommand request, CancellationToken cancellationToken)
    {
