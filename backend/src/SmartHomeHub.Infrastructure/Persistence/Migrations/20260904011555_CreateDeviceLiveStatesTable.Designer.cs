...
namespace SmartHomeHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260904011555_CreateDeviceLiveStatesTable")]
    partial class CreateDeviceLiveStatesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartHomeHub.Domain.Entities.Device", b =>
                {
                    ...
                    b.Property<int?>("ColorTempPercent")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartHomeHub.Domain.Entities.DeviceLiveState", b =>
                {
                    ...
                    b.ToTable("DeviceLiveStates", (string)null);
                });
            ...
            modelBuilder.Entity("SmartHomeHub.Domain.Entities.SystemEvent", b =>
                {
                    ...
                    b.HasIndex("UserId", "DeviceGroupId", "Timestamp")
                        .IsDescending(false, false, true);

                    b.HasIndex("UserId", "DeviceId", "Timestamp")
                        .IsDescending(false, false, true);
            ...
            modelBuilder.Entity("SmartHomeHub.Domain.Entities.DeviceLiveState", b =>
                {
                    b.HasOne("SmartHomeHub.Domain.Entities.Device", "Device")
                        .WithOne("LiveState")
                        .HasForeignKey("SmartHomeHub.Domain.Entities.DeviceLiveState", "DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("SmartHomeHub.Domain.ValueObjects.DeviceLiveStateAttributes", "Attributes", b1 =>
                        {
                            b1.Property<Guid>("DeviceLiveStateDeviceId");

                            b1.Property<int?>("Brightness");

                            b1.Property<string>("ColorHex");

                            b1.Property<int?>("ColorTempPercent");
                            ...
                            b1.WithOwner()
                                .HasForeignKey("DeviceLiveStateDeviceId");
                        });
