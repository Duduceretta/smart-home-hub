...
namespace SmartHomeHub.IntegrationTests.Features.Devices.Commands.SetDeviceColorTemp;

public class SetDeviceColorTempTests(IntegrationTestWebAppFactory factory)
    : BaseIntegrationTest(factory)
{
    ...
    private record DeviceResponse(Guid Id, int? ColorTempPercent);
    ...
    [Fact]
    public async Task SetDeviceColorTemp_TuyaLocalSuccess_ShouldPersistColorTempAndBeReturnedByGet()
    {
        ResetTuyaService();
        ...
        _tuyaLocalControlService
            ...
            .Returns(Result.Success(new TuyaColorTempCommandOutcome(null, null)));

        var putResponse = await Client.PutAsJsonAsync(
            $"/api/devices/{device.Id}/color-temp",
            new { ColorTempPercent = 70 },
        ...
        deviceResponse!.ColorTempPercent.Should().Be(70);
    }

    [Fact]
    public async Task SetDeviceColorTemp_TuyaLocalFails_ShouldNotPersistColorTemp()
    {
        ResetTuyaService();
        ...
        _tuyaLocalControlService
            ...
            .Returns(
                Result.Failure<TuyaColorTempCommandOutcome>(
    ...
    [Fact]
    public async Task GetDeviceById_DeviceNeverHadColorTempSet_ShouldReturnNullColorTempPercentWithoutBreakingSerialization()
    {
        ...
        deviceResponse.Should().NotBeNull();
        deviceResponse!.ColorTempPercent.Should().BeNull();
    }
}
