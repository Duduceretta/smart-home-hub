					...
					return (
						<button
							...
							className={cn(
								...
								option.comingSoon
									? "cursor-not-allowed border-border-subtle/20 bg-surface-container/50 opacity-50"
									: "cursor-pointer border-border-subtle/20 bg-surface-container hover:border-primary/25",
								isSelected &&
									!option.comingSoon &&
						...
						>
							<div className="flex items-center justify-between">
								...
								{option.comingSoon && (
									<span className="rounded-full border border-border-subtle/40 px-1.5 py-0.5 text-[9px] font-medium uppercase tracking-wider text-muted-foreground">
										Em breve
									</span>
								)}
							</div>
