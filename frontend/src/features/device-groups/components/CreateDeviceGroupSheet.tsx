...
export const CreateDeviceGroupSheet: React.FC = () => {
	...
	return (
		<SheetLayout
			...
			description="Crie um grupo de dispositivos para organizar e controlar vários equipamentos de uma só vez."
			footer={
				<>
					<button
						type="button"
					...
					>
						...
						<span className="relative z-10">Registrar Grupo</span>
