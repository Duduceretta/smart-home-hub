...
const SummarySection: React.FC<{
	...
	<div className="rounded-xl border border-border-subtle bg-surface-low p-4 shadow-xs">
		<div className="flex items-center gap-2 border-b border-border-subtle/60 pb-2 text-primary">
			<Icon className="h-3.5 w-3.5" />
			<span className="text-xs font-semibold uppercase tracking-wider">
				{title}
			</span>
		</div>
		<div className="divide-y divide-border-subtle/60 pt-1">{children}</div>
	</div>
);
...
export const DiscoveryStepDone: React.FC = () => {
		...
		return (
			<div className="flex flex-1 flex-col items-center justify-center gap-4 text-center">
				<div className="relative flex h-16 w-16 items-center justify-center">
					<span
						className="absolute inset-0 rounded-full bg-primary/20 blur-xl motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-50 motion-safe:duration-700 motion-safe:ease-out"
						aria-hidden
					/>
					<span className="relative flex h-14 w-14 items-center justify-center rounded-full border border-primary/30 bg-primary/15 text-primary ring-4 ring-primary/10 shadow-xs motion-safe:animate-in motion-safe:zoom-in-50 motion-safe:duration-500 motion-safe:ease-out">
				...
				<div className="mt-2 flex items-center gap-2.5 motion-safe:animate-in motion-safe:fade-in motion-safe:duration-300 motion-safe:fill-mode-backwards motion-safe:delay-[480ms]">
					<button
						type="button"
					...
					<button
						...
						className="h-8.5 rounded-lg border border-border bg-surface-high px-5 text-xs font-semibold text-foreground transition-all hover:border-foreground/30 hover:bg-surface-highest cursor-pointer shadow-xs active:scale-[0.98]"
					>
	...
	return (
		<div className="flex flex-1 flex-col gap-4">
			...
			<div className="flex flex-col gap-3.5 overflow-y-auto scrollbar-gutter-stable scrollbar-thin">
				<SummarySection
					icon={BadgeInfo}
