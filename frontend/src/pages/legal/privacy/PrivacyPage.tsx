...
const PRIVACY_TOC = [
	{ id: "responsavel", title: "Responsável pelo Tratamento" },
	{ id: "dados-coletados", title: "Dados Pessoais Coletados" },
	{ id: "finalidades", title: "Finalidades e Bases Legais (LGPD)" },
	{ id: "compartilhamento", title: "Compartilhamento com Terceiros" },
	{ id: "retencao", title: "Retenção e Descarte de Dados" },
	{ id: "direitos-titular", title: "Direitos do Titular de Dados" },
	{ id: "cookies-armazenamento", title: "Cookies e Armazenamento Local" },
...
export function PrivacyPage() {
	return (
		<LegalLayout
			...
			subtitle="Como o Nexus Hub coleta, utiliza, armazena e protege seus dados pessoais de acordo com a LGPD."
			lastUpdated="10 de setembro de 2026"
			tableOfContents={PRIVACY_TOC}
			counterpartLink={{
				to: "/legal/terms",
				label: "Acesse também os Termos de Serviço do Nexus Hub",
			}}
		>
