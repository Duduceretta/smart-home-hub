...
const TERMS_TOC = [
	{ id: "natureza-servico", title: "Natureza do Serviço e Estágio" },
	{ id: "aceitacao", title: "Aceitação dos Termos" },
	{ id: "responsabilidades", title: "Responsabilidades do Usuário" },
	{ id: "dispositivos", title: "Uso com Dispositivos Físicos" },
	{ id: "terceiros", title: "Integrações e Serviços de Terceiros" },
	{ id: "disponibilidade", title: "Isenção de Garantias e Limites" },
...
export function TermsPage() {
	return (
		<LegalLayout
			...
			subtitle="Condições e diretrizes para utilização da plataforma de automação residencial Nexus Hub."
			lastUpdated="10 de setembro de 2026"
			tableOfContents={TERMS_TOC}
			counterpartLink={{
				to: "/legal/privacy",
				label: "Consulte também nossa Política de Privacidade (LGPD)",
			}}
		>
