...
export function ArchitecturalResidenceIllustration({
	...
	const [isLivingLampOn, setIsLivingLampOn] = useState(false);
	const [isBedroomLampOn, setIsBedroomLampOn] = useState(true);
	const [isOfficeLampOn, setIsOfficeLampOn] = useState(true);
	...
	return (
		...
		>
			...
			<g>
				...
				{/* Brilho interior acolhedor suave que preenche a residência */}
				<rect
					x="45"
					y="180"
					width="750"
				...
				{/* Montantes e pilares verticais esguios */}
				<rect
					x="45"
					y="180"
					width="16"
				...
				{/* ========================================================================= */}
				{/* PAREDES DE FUNDO: ELEMENTOS CURADOS EM ESPAÇOS VAZIOS (DESALINHADOS)     */}
				{/* ========================================================================= */}
				...
				<g filter="url(#soft-contact-shadow)">
					...
					{/* --- PONTOS DE ESTRELAS NO CÉU ESCURO --- */}
					{/* Painel Esquerdo */}
					<circle
						cx="310"
						cy="245"
					...
					<circle
						...
						opacity="0.18"
					/>
					<circle cx="325" cy="260" r="0.7" fill="var(--warm)" opacity="0.8" />
					<circle
						cx="305"
						cy="285"
						r="0.9"
						...
						opacity="0.85"
					/>
					<circle cx="338" cy="295" r="1.4" fill="var(--warm)" opacity="0.9" />
					<circle
						cx="342"
						cy="250"
						r="0.6"
					...
					<circle
						...
						opacity="0.75"
					/>
					<circle cx="330" cy="350" r="1.0" fill="var(--warm)" opacity="0.8" />
					<circle
						cx="308"
						cy="365"
						r="0.6"
					...
					{/* Painel Central (Estrela Polar em destaque com brilho cruzado) */}
					<circle
						cx="385"
						cy="248"
						r="1.6"
					...
					<line
						...
						opacity="0.75"
					/>
					<circle cx="370" cy="275" r="0.8" fill="var(--warm)" opacity="0.85" />
					<circle
						cx="398"
						cy="282"
						r="1.1"
						...
						opacity="0.9"
					/>
					<circle cx="362" cy="305" r="0.6" fill="var(--warm)" opacity="0.65" />
					<circle
						cx="378"
						cy="325"
						r="1.3"
						...
						opacity="0.9"
					/>
					<circle cx="405" cy="318" r="0.7" fill="var(--warm)" opacity="0.75" />
					<circle
						cx="392"
						cy="355"
						r="0.8"
						...
						opacity="0.7"
					/>
					<circle cx="368" cy="370" r="0.6" fill="var(--warm)" opacity="0.6" />

					{/* Painel Direito */}
					<circle cx="445" cy="242" r="1.3" fill="var(--warm)" opacity="0.9" />
					<circle
						cx="445"
						cy="242"
						r="3.2"
					...
					<circle
						...
						opacity="0.8"
					/>
					<circle cx="460" cy="258" r="1.0" fill="var(--warm)" opacity="0.85" />
					<circle
						cx="438"
						cy="290"
						r="0.6"
					...
					<circle
						...
						opacity="0.9"
					/>
					<circle cx="426" cy="335" r="0.7" fill="var(--warm)" opacity="0.75" />
					<circle
						cx="465"
						cy="345"
						r="0.9"
						...
						opacity="0.8"
					/>
					<circle cx="440" cy="368" r="0.6" fill="var(--warm)" opacity="0.6" />
				...
				<g filter="url(#soft-contact-shadow)">
					...
					<ellipse
						...
						opacity="0.85"
					/>
					<circle cx="620" cy="314" r="2.5" fill="var(--warm)" opacity="0.8" />
				...
				<g>
					<rect
						...
						strokeWidth="1"
					/>
					<rect x="209" y="554" width="56" height="36" fill="var(--popover)" />
					<path
						...
						opacity="0.8"
					/>
					<circle cx="251" cy="565" r="4" fill="var(--primary)" opacity="0.4" />
				</g>
				...
				<g>
					...
					<line
						...
						strokeLinecap="round"
					/>
					<circle cx="299" cy="590" r="1.5" fill="var(--warm)" opacity="0.9" />
				...
				<g>
					...
					<g transform="rotate(-50 357 517)">
						{/* Haste de suporte */}
						<rect x="355.5" y="517" width="3" height="4" fill="var(--border)" />
			...
			<g>
				...
				<g filter="url(#soft-contact-shadow)">
					...
					<circle cx="130" cy="320" r="12" fill="var(--warm)" opacity="0.55" />
					<path
				...
				<g
					...
					onClick={() => setIsBedroomLampOn((prev) => !prev)}
				...
				{/* Luminária spot contemporânea de sobrepor (grudada no teto a y=205, alinhada com alto-falante direito x=666) */}
				...
				{/* Hotspot de clique do Spot do Home Office (tabIndex=-1, não distrai tab do login) */}
				{/* biome-ignore lint/a11y/useSemanticElements: SVG group used as interactive vector hotspot */}
				<g
					role="button"
					tabIndex={-1}
					aria-label="Alternar luz do escritório (decorativo)"
					onClick={() => setIsOfficeLampOn((prev) => !prev)}
					className="cursor-pointer group"
				>
					{/* Área de toque expandida invisível */}
					<circle cx="666" cy="216" r="22" fill="transparent" />
				...
				{/* Mesa de trabalho e monitor ultrawide mantidos */}
				<rect
					x="545"
					y="425"
					width="150"
				...
				<circle
					...
					strokeWidth="0.6"
				/>
				<circle cx="574" cy="418" r="1.5" fill="var(--primary)" opacity="0.7" />
				...
				<circle
					...
					strokeWidth="0.6"
				/>
				<circle cx="666" cy="418" r="1.5" fill="var(--primary)" opacity="0.7" />
				...
				<g
					...
					onClick={() => setIsLivingLampOn((prev) => !prev)}
					className="cursor-pointer group"
				>
					{/* Área de toque expandida invisível */}
